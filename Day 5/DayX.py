## variables ##
filePaths = {
    '1': 'Day 5\Input files\Input.txt',
    '2': 'Day 5\Input files\TestInput.txt',
    '3': 'Day 5\Input files\TestInputPart2.txt'
}
...
print(f'The answer to day 5 part 1 = {part1answer}')
if choice == '2':
...
print(f'The answer to day 5 part 2 = {part2answer}')
if choice == '2':
